...
function onMediaDevicesListChanged(devicesReceived) {
    ...
    // Used by tracks to update the real device id before the consumer of lib-VideoAPI-meet receives the new device list.
        ...
        return new Promise((resolve, reject) => {
            ...
            navigator.mediaDevices.getUserMedia(constraints)
                ...
                .catch(error => {
                    ...
                    const VideoAPIError = new VideoAPITrackError(error, constraints, umDevices);
                    ...
                    if (VideoAPIError.name === VideoAPITrackErrors.PERMISSION_DENIED) {
