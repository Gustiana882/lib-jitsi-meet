...
TraceablePeerConnection.prototype._remoteTrackAdded = function(stream, track, transceiver = null) {
    ...
    if (FeatureFlags.isSourceNameSignalingEnabled()) {
        ...
        if (!sourceName) {
            sourceName = getSourceNameForVideoAPITrack(ownerEndpointId, mediaType, 0);
        }
    }
 ...
 * For VideoAPI, these tracks are actually receive-only ssrcs. To prevent
 ...
 * @param {VideoAPILocalTrack} track the track to be added as part of the unmute operation.
 *
 ...
 * <tt>oldTrack</tt>
 *
 * @param {VideoAPILocalTrack|null} oldTrack - The current track in use to be replaced on the pc.
 * @param {VideoAPILocalTrack|null} newTrack - The new track to be used.
 *
