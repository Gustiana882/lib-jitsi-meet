...
const ScreenObtainer = {
            ...
            return (onSuccess, onFailure) => {
                window.VideoAPIMeetNW.obtainDesktopStream(
                    ...
                    (error, constraints) => {
                        ...
                        // streamId to lib-VideoAPI-meet. This way the desktop
                        // sharing implementation for NWJS and chrome extension
                        // will be the same and lib-VideoAPI-meet will be able to
                        ...
                        if (error && error.name === 'InvalidStateError') {
                            VideoAPIError = new VideoAPITrackError(
    ...
    obtainScreenOnElectron(onSuccess, onFailure) {
        if (window.VideoAPIMeetScreenObtainer && window.VideoAPIMeetScreenObtainer.openDesktopPicker) {
            ...
            window.VideoAPIMeetScreenObtainer.openDesktopPicker(
                ...
                (streamId, streamType, screenShareAudio = false) => {
                    if (streamId) {
                        ...
                        onFailure(new VideoAPITrackError(VideoAPITrackErrors.SCREENSHARING_USER_CANCELED));
                    }
                },
            ...
            onFailure(new VideoAPITrackError(VideoAPITrackErrors.ELECTRON_DESKTOP_PICKER_NOT_FOUND));
        }
    },
