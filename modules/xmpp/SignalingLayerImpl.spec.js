...
describe('SignalingLayerImpl', () => {
    describe('setTrackMuteStatus advertises the track muted status in the chat room', () => {
        describe('with source name signaling enabled', () => {
            ...
            it('for audio track', () => {
                const audioSourceName = getSourceNameForVideoAPITrack(endpointId, MediaType.AUDIO, 0);
            ...
            it('for video track', () => {
                const videoSourceName = getSourceNameForVideoAPITrack(endpointId, MediaType.VIDEO, 0);
