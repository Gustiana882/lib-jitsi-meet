...
/**
 * Initializes Strophe plugins that need to work with Strophe.Connection directly rather than the lib-VideoAPI-meet's
                ...
                const processLobbyFeatures = f => {
                    f.forEach(fr => {
                        if (fr.endsWith('#displayname_required')) {
                            this.eventEmitter.emit(VideoAPIConnectionEvents.DISPLAY_NAME_REQUIRED);
                        }
                    });
                };
